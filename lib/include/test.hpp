...
#define TEST_PARENS_REMOVE(expr) TEST_PARENS_REMOVE_IMPL(TEST_PARENS_CHECK(TEST_PARENS_PROBE expr))(expr)
        ...
        {                                                                                                                                    \
            ...
            {                                                                                                                                \
                ...
                {                                                                                                                            \
                    ...
                    auto find_test       = [&r, &tg, &attr_str, &code, &bmatch, &ematch](nstd::TestKind kind, std::regex& pattern) -> bool { \
                        std::smatch tr;                                                                                                \
