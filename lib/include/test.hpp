        ...
        {                                                                                          \
            ...
            {                                                                                      \
                ...
                {                                                                                  \
                    ...
                    if(find_test(nstd::TestKind::UNIT_TEST, utest_pattern))                        \
                    {                                                                              \
                        continue;                                                                  \
                    }                                                                              \
                    if(find_test(nstd::TestKind::INTEGRATION_TEST, itest_pattern))                 \
                    {                                                                              \
                        continue;                                                                  \
                    }                                                                              \
                    if(find_test(nstd::TestKind::BENCHMARK, bench_pattern))                        \
                    {                                                                              \
                        continue;                                                                  \
                    }                                                                              \
                    if(find_test(nstd::TestKind::STRESS_TEST, stress_pattern))                     \
                    {                                                                              \
                        continue;                                                                  \
                    }                                                                              \
                }                                                                                  \
