...
public:
    ...
    SelfRef(nstd::in_place_type_t<D> it, Args&&... args)
    ...
    inline constexpr nstd::add_const_t<nstd::add_pointer_t<B>> operator->() const noexcept
    {
        return &ref;
    }
...
SelfRef<B> make_self_ref(Args&&... args)
{
